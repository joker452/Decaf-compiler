...
public abstract class Tree {
     ...
     */
    public static final int SCOPY = COMPREHENSION + 1;
     ...
     */
    public static final int SELECT = GUARD + 1;
   ...
   public static class Scopy extends Tree {
	...
	public Comprehension(Expr action, String id, Expr range, Expr condition, Location loc) {
