...
public class Translater {
	...
	/**
	 * set paramMemo of currentFuncty, and append the label to the
	 * tail of currentFuncty
	 */
	...
	/**
	 * add currentFuncty to funcs, then set currentFuncty to null
	 */
	public void endFunc() {
	...
	public void genCheckDivsion(Temp operand) {
		Temp zero = genLoadImm4(0);
		Label exit = Label.createLabel();
		Temp cond = genEqu(operand, zero);
		genBeqz(cond, exit);
	...
	public void genNewForClass(Class c) {
		...
		// substract 1 for the class pointer which always exists
