...
public class Class extends Symbol {
	...
	/**
	 * Set the order (0 based) of nonstatic functions and variables 
	 * in the associated scope of class and the size of this Class symbol
	 */
	public void resolveFieldOrder() {
		...
		// resolve order for parent class first
		if (parentName != null) {
		...
		while (iter.hasNext()) {
			...
			// no need to set order for static function
